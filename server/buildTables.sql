...
(
    ...
    CONSTRAINT league_user_id PRIMARY KEY (leagueid, userid),
    CONSTRAINT league_users_leagueid_fkey FOREIGN KEY (leagueid)
        REFERENCES public.leagues (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT league_users_userid_fkey FOREIGN KEY (userid)
        ...
        ALTER TABLE public.riders
            ...
            ALTER TABLE public.season_weeks
                ...
                ALTER TABLE public.seasons
                    ...
                    -- Index: sessions_expired_index

                    -- DROP INDEX public.sessions_expired_index;

                    CREATE INDEX sessions_expired_index
